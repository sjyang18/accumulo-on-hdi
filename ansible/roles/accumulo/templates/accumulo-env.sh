...
export ZOOKEEPER_HOME="${ZOOKEEPER_HOME:-/usr/hdp/current/zookeeper-client}"
...
CLASSPATH="${CLASSPATH}:${lib}/*:${HADOOP_CONF_DIR}:${ZOOKEEPER_HOME}/*:${HADOOP_HOME}/client/*:${HADOOP_HOME}/*:/usr/hdp/current/hadoop-hdfs-client/*:/usr/hdp/current/hadoop-hdfs-client/lib/*"
export CLASSPATH
